...
try {
  ...
  const playgroundSdkRuntimePath = join(repoRoot, "lib/playground-sdk-runtime.ts");
  writeFileSync(
    playgroundSdkRuntimePath,
    `// Auto-generated by scripts/sync-flowr-sdk-local.mjs — do not edit.
export const playgroundSdkEntryUrl =
  "/vendor/flowr/sdk-recorder-local/index.js?v=${browserEntrySha256.slice(0, 12)}";
export const playgroundSdkEntrySha256 = "${browserEntrySha256}";
`,
  );
